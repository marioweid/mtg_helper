...
Use commander text first, then deck cards/tags, bracket, memory, and user goal.
Be specific: prefer "Golgari Food Squirrel Aristocrats" over "midrange".
Do not recommend cards. Do not list cuts. Identify tensions that later agents
should solve.
"""
...
async def identify_deck(
    ...
    *,
    ...
    payload = pipeline.deck_profile(deck, coach_memory_notes, user_goal)
    try:
