...
const OPTIONS: { href: string; title: string; subtitle: string; description: string }[] = [
  ...
  },
  {
    ...
    description:
      "Pick a commander, then select EDHREC themes. Suggestions are tag-driven from there.",
  },
  {
    ...
    description:
      "Describe what you want; the agent asks 1-3 short questions, then converges on EDHREC themes for you. You can fine-tune the chips before creating.",
  },
  {
    href: "/decks/import",
    ...
    description:
      "Paste a Moxfield/Archidekt list or URL. After import you'll set EDHREC themes from the cards we detected so further suggestions stay on-theme.",
  },
];
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader
        ...
        subtitle="Three paths. Pick whichever fits your mood - they all converge on EDHREC themes."
      />
